...
#boxplot.stats(Total_number_of_mosquitoes~Treatment, data=indices, boxwex=0.5, col=colors, 
 #             cex.axis=0.5, ylab="Total_number_of_mosquitoes")
 summary(w)
...
#ggplot:Total number of mosquitoes
...
library(vegan)
s#etwd("C:/Users/tocon/Desktop/ashwin/work/Avian Malaria/Mosquito_sampling_Sky_Island/Abirami_work")
#read data
#mosq=read.csv("Mosq_AB.csv")
#plotting abundances
#colors = terrain.colors(6)[5:1]
#boxplot(Mosq_tot~Treatment, data=mosq, boxwex=0.5, col=colors,
#        cex.axis=0.85, ylab="Abundance")


#testing abundance difference among habitats
...
#Testing unwanted dipteran abundance among treatments
...
#Testing lepidopteran abundance among treatments
...
citation()
#Modeling the mosquito abundance/trap-night with the avg temperature of the preceding day
...
#Modeling the mosquito abundance/trap-night with the avg humidity of the preceding day
...
#dunnTest(Total_number_of_mosquitoes~Treatment,data=indices)
